 ...
 */
final class Version20240105111233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, page_section_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_140AB620D3C3D2E4 (page_section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE page_section (id INT AUTO_INCREMENT NOT NULL, ordered INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE section (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, page_section_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug_section VARCHAR(255) NOT NULL, INDEX IDX_2D737AEFC54C8C93 (type_id), INDEX IDX_2D737AEFD3C3D2E4 (page_section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE page ADD CONSTRAINT FK_140AB620D3C3D2E4 FOREIGN KEY (page_section_id) REFERENCES page_section (id)');
        $this->addSql('ALTER TABLE section ADD CONSTRAINT FK_2D737AEFC54C8C93 FOREIGN KEY (type_id) REFERENCES type (id)');
        $this->addSql('ALTER TABLE section ADD CONSTRAINT FK_2D737AEFD3C3D2E4 FOREIGN KEY (page_section_id) REFERENCES page_section (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page DROP FOREIGN KEY FK_140AB620D3C3D2E4');
        $this->addSql('ALTER TABLE section DROP FOREIGN KEY FK_2D737AEFC54C8C93');
        $this->addSql('ALTER TABLE section DROP FOREIGN KEY FK_2D737AEFD3C3D2E4');
